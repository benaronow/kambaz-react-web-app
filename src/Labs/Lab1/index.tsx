    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Start with two pounds of pork shoulder.</li>
          <li>Cut pork into 6-7 pieces.</li>
          <li>
            Mix brown sugar, smoked paprika, garlic powder, onion powder, salt,
            and pepper.
          </li>
          <li>Rub pork with spice mixture.</li>
          <li>Sear pork for 5 minutes (2.5 each side) with olive oil.</li>
          <li>Pour 1 cup water and 3/4 coke into pot.</li>
          <li>Pressure cook for 40 minutes or slow cook for 6 hours.</li>
          <li>Shred meat with a fork.</li>
          <li>Put between two pieces of bread and eat.</li>
        </ol>
      ...
      <br />
      <a
        href="https://github.com/benaronow/kambaz-react-web-app"
        id="wd-github"
      >
        {"Click here "}
      </a>
